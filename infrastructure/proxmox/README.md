...
This directory contains the initial Terraform configuration used to provision Ubuntu virtual machines on my Proxmox VE homelab.
...
├── main.tf
├── outputs.tf
├── providers.tf# Proxmox Terraform Infrastructure
...
The Proxmox API token is provided through the environment variable:
...
This confirms that the configuration is idempotent and that Terraform state matches the real Proxmox infrastructure.
...
The current resource values are defined directly in main.tf
